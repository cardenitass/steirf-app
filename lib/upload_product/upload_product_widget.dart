...
class UploadProductWidget extends StatefulWidget {
  const UploadProductWidget({Key? key}) : super(key: key);

  @override
  _UploadProductWidgetState createState() => _UploadProductWidgetState();
}
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Publica, hazte conocido como artista y vende',
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Escribe una breve descripción de lo que trata tu obra de arte...',
                            hintStyle: FlutterFlowTheme.of(context).labelMedium,
                            enabledBorder: UnderlineInputBorder(
                              borderSide: BorderSide(
                                color: FlutterFlowTheme.of(context).alternate,
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(
                                ...
                                color: FlutterFlowTheme.of(context).azure,
                                size: 32.0,
                              ),
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
