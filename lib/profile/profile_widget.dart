      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: FlutterFlowTheme.of(context).xanthous,
                            width: 2.0,
                          ),
                        ),
                        child: Padding(
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(24.0, 0.0, 16.0, 15.0),
              child: Row(
                mainAxisSize: MainAxisSize.max,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('UploadProduct');
                },
                child: Container(
                  width: double.infinity,
                  height: 60.0,
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  context.pushNamed('BoughtProducts');
                },
                child: Container(
                  width: double.infinity,
                  height: 60.0,
